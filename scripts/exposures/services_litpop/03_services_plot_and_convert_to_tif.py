...
data_root_dir = Path('/Users/chrisfairless/Data/UNU/gambia2025/inputs/exposures/services_NCCS/')
...
for country in country_list:
    ...
    hdf5_filename = f'services_litpop_{country_iso}.h5'
    tif_filename = f'services_litpop_{country_iso}.tif'
    png_filename = f'services_litpop_{country_iso}.png'
    ...
    ax = exp.plot_raster(
        save_tiff=tif_path,
        raster_f=lambda x: x,
        label="Services economic exposure (USD)",
        axis=ax,
        fill=False,
        adapt_fontsize=True,
    )
