...
data_root_dir = Path('/Users/chrisfairless/Data/UNU/gambia2025/inputs/exposures/energy_NCCS/')
...
print('Downscaling NCCS energy exposures to populated areas.')  # Best we can do for now, sorry
...
for country in country_list:
    ...
    hdf5_filename = f'energy_nccs_{country_iso}.h5'
    mask_filename = f'ghs_pop_{country_iso}.hdf5'
    out_filename = f'energy_nccs_downscaled_{country_iso}.hdf5'
    csv_filename = f'energy_nccs_downscaled_{country_iso}.csv'
    ...
    mask_gdf['centr'] = idx
    # mask_gdf['count'] = mask_gdf.groupby(['centr'])['centr'].transform('count')
