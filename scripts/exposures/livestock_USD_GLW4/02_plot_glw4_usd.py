...
country_list = ['Gambia']
exposure_dir = Path('/Users/chrisfairless/Data/UNU/gambia2025/inputs/exposures/livestock_USD_GLW4/exp/')
plot_dir = Path('/Users/chrisfairless/Data/UNU/gambia2025/inputs/exposures/livestock_USD_GLW4/plots/')
overwrite = True
# cmap = 'viridis'
cmap = 'magma_r'
...
for country in country_list:
    ...
    for i, species in enumerate(species_list):
        exposure_file = Path(exposure_dir,  f'glw4_USD_{species}_{country_iso}_5as.hdf5')
        ...
        _ = exp.plot_basemap(
                    ...
                    zoom=10,
                    title=f'{species.capitalize()}: {np.floor(total_value)} USD',
